...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset_path', default='D:\\DingYi\\Dataset\\MAHNOB-P', type=str,
                        help='The root directory of the dataset.')
    parser.add_argument('-dataset_folder', default='compacted_{:d}'.format(frame_size), type=str,
                        help='The root directory of the dataset.')
    parser.add_argument('-load_path', default='D:\\DingYi\\GiG\\load\\model_load_path', type=str, help='The path to load the trained model.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-save_path', default='D:\\DingYi\\GiG\\save', type=str, help='The path to save the trained model ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='D:\\DingYi\\GiG', type=str, help='The path to the entire repository.')
    ...
    parser.add_argument('-model_name', default="GiG", help='Model: eegnet, tcn, lstm, satcn, msatcn, EmT')
